...
def check_face(img_path, k_eig_vec, mean_face, h, w, threshold):
    ...
    error = np.linalg.norm(
        resized_img.astype(np.float32) - img_recon.astype(np.float32), 2
    )
...
def main():
    ...
    resized_img = cv2.resize(img_trump, (h, w), interpolation=cv2.INTER_AREA).reshape(
        -1, 1
    )
    ...
    TP += check_face(
        "data/exercise1/detect/face/boris.jpg",
        eig_vec[:, -k:],
        mean_face,
        h,
        w,
    ...
    TP += check_face(
        "data/exercise1/detect/face/merkel.jpg",
        eig_vec[:, -k:],
        mean_face,
        h,
        w,
    ...
    TP += check_face(
        "data/exercise1/detect/face/obama.jpg",
        eig_vec[:, -k:],
        mean_face,
        h,
        w,
    ...
    TP += check_face(
        "data/exercise1/detect/face/putin.jpg",
        eig_vec[:, -k:],
        mean_face,
        h,
        w,
    ...
    TP += check_face(
        "data/exercise1/detect/face/trump.jpg",
        eig_vec[:, -k:],
        mean_face,
        h,
        w,
    ...
    TN += not (
        check_face(
            "data/exercise1/detect/other/cat.jpg",
            eig_vec[:, -k:],
            mean_face,
            h,
            w,
    ...
    TN += not (
        check_face(
            "data/exercise1/detect/other/dog.jpg",
            eig_vec[:, -k:],
            mean_face,
            h,
            w,
    ...
    TN += not (
        check_face(
            "data/exercise1/detect/other/flag.jpg",
            eig_vec[:, -k:],
            mean_face,
            h,
            w,
    ...
    TN += not (
        check_face(
            "data/exercise1/detect/other/flower.jpg",
            eig_vec[:, -k:],
            mean_face,
            h,
            w,
    ...
    TN += not (
        check_face(
            "data/exercise1/detect/other/monkey.jpg",
            eig_vec[:, -k:],
            mean_face,
            h,
            w,
    ...
    predicted_y = y_train[idx].reshape(
        -1,
    )
